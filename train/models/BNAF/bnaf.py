"""
This file is inherited from https://github.com/nicola-decao/BNAF
"""
import torch
import math
import numpy as np

class BNAFSequential(torch.nn.Sequential):
  """
...
class MaskedWeight(torch.nn.Module):
  ...
  def get_weights(self):
    ...
    """
    if self.training:
      w = torch.exp(self._weight) * self.mask_d + torch.exp(self._weight) * self.mask_o
